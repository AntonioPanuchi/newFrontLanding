...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Он помогает отслеживать доступность серверов и не является рекламой VPN‑услуг.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Нет, проект предназначен исключительно для технического мониторинга.'
  },
  {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-8 max-w-3xl sm:max-w-4xl">
        ...
        <Accordion.Root type="multiple" className="flex flex-col gap-6" collapsible>
          {faqs.map((faq, i) => (
            <Accordion.Item
              key={i}
              value={String(i)}
