...
const features = [
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M12 28L28 12" stroke="#fff" strokeWidth="3" strokeLinecap="round"/>
        <path d="M20 12L28 12L28 20" stroke="#fff" strokeWidth="3" strokeLinecap="round"/>
        <defs>
          <linearGradient id="speed-gradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
  ...
  },
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M20 10L30 15V22C30 28 20 32 20 32C20 32 10 28 10 22V15L20 10Z" stroke="#fff" strokeWidth="2.5" fill="#fff2"/>
        <defs>
  ...
  },
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="12" y="16" width="16" height="12" rx="4" fill="#fff" stroke="#0ea5e9" strokeWidth="2"/>
        <rect x="17" y="12" width="6" height="6" rx="3" fill="#fff" stroke="#22c55e" strokeWidth="2"/>
        <circle cx="16" cy="22" r="1.5" fill="#22c55e" />
        <circle cx="24" cy="22" r="1.5" fill="#22c55e" />
        <defs>
          <linearGradient id="robot-gradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
